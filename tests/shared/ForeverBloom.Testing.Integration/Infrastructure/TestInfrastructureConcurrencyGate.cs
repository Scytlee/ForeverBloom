...
{
    private static readonly Lazy<SemaphoreSlim> LazyGate =
        new(CreateGate, LazyThreadSafetyMode.ExecutionAndPublication);

    private static readonly Lazy<TestInfrastructureSettings> LazySettings =
        new(TestInfrastructureSettingsLoader.Load, LazyThreadSafetyMode.ExecutionAndPublication);
