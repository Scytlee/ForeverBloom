...
namespace ForeverBloom.WebApi.IntegrationTests.TestInfrastructure;
...
/// </summary>
public static class RouteEndpointAssertions
{
    /// <summary>
    ...
    /// <summary>
    /// Asserts that the endpoint enriches ProblemDetails with additional metadata.
    /// </summary>
    /// <param name="endpoint">The endpoint to validate</param>
    public static void ShouldEnrichProblemDetails(this RouteEndpoint endpoint)
    {
        ArgumentNullException.ThrowIfNull(endpoint);

        var metadata = endpoint.Metadata.GetMetadata<EnrichesProblemDetails>();
