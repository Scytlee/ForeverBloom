...
namespace ForeverBloom.WebApi.Helpers;
...
public static class ProblemDetailsHelper
{
    ...
    /// </summary>
    /// <param name="statusCode">The status code of the HTTP response.</param>
    /// <param name="errors">An array of ErrorDetail objects representing domain errors.</param>
    /// <returns>A BadRequestProblemDetails object containing type, title, status, and error details.</returns>
    public static BadRequestProblemDetails CreateBadRequestProblemDetails(int statusCode, ErrorDetail[] errors)
    {
        var problemDetails = new BadRequestProblemDetails(errors);
        ApplyProblemDetailsDefaults(problemDetails, statusCode);
